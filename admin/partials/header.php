...
$coreNav = [
    ...
    [
        'slug'  => 'content-styles',
        'label' => __('global_styles', 'Global Styles'),
        'href'  => SLATE_URL . '/admin/styles.php',
        'icon'  => 'palette',
        'perm'  => 'content.edit',
        'order' => 140,
        'group' => 'content',
...
// Canonical group ordering: Overview -> Editor -> Content -> Business plugins -> Settings -> System -> other
